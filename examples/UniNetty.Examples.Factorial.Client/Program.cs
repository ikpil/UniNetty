...
namespace UniNetty.Examples.Factorial.Client
{
    ...
    class Program
    {
        static async Task RunClientAsync()
        {
            ...
            if (UniNetty.Examples.Common.ClientSettings.IsSsl)
            {
            ...
            try
            {
                ...
                IChannel bootstrapChannel = await bootstrap.ConnectAsync(new IPEndPoint(UniNetty.Examples.Common.ClientSettings.Host, UniNetty.Examples.Common.ClientSettings.Port));
