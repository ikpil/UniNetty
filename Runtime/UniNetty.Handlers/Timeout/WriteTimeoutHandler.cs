...
namespace UniNetty.Handlers.Timeout
{
    ...
    ///
    /// <c>
    /// var bootstrap = new <see cref="UniNetty.Transport.Bootstrapping.ServerBootstrap"/>();
    ///
    ...
    public class WriteTimeoutHandler : ChannelHandlerAdapter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UniNetty.Handlers.Timeout.ReadTimeoutHandler"/> class.
        /// </summary>
