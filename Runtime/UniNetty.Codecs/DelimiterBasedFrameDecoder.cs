...
namespace UniNetty.Codecs
{
    ...
    /// <summary>
    ///     A decoder that splits the received <see cref="UniNetty.Buffers.IByteBuffer" /> by one or more
    ///     delimiters.It is particularly useful for decoding the frames which ends
    ///     with a delimiter such as <see cref="UniNetty.Codecs.Delimiters.NullDelimiter" /> or
    ///     <see cref="UniNetty.Codecs.Delimiters.LineDelimiter" />
    ///     <h3>Specifying more than one delimiter </h3>
    ///     <see cref="UniNetty.Codecs.Delimiters.NullDelimiter" /> allows you to specify more than one
    ...
    ///     | ABC\nDEF\r\n |
    ///     +--------------+
    ///     a <see cref="UniNetty.Codecs.Delimiters.LineDelimiter" /> will choose '\n' as the first delimiter and produce two
    ///     frames:
    ///     +-----+-----+
    ///     | ABC | DEF |
    ///     +-----+-----+
    ...
    public class DelimiterBasedFrameDecoder : ByteToMessageDecoder
    {
        ...
        ///     NOTE: A see <see cref="UniNetty.Codecs.TooLongFrameException" /> is thrown if the length of the frame exceeds this
        ///     value.
        /// </param>
        /// <param name="stripDelimiter">whether the decoded frame should strip out the delimiter or not</param>
        /// <param name="failFast">
        ///     If true, a <see cref="UniNetty.Codecs.TooLongFrameException" /> is
        ///     thrown as soon as the decoder notices the length of the
        ///     frame will exceed<tt>maxFrameLength</tt> regardless of
        ///     whether the entire frame has been read.
        ///     If false, a <see cref="UniNetty.Codecs.TooLongFrameException" /> is
        ...
        /// <summary>Create a frame out of the <see cref="UniNetty.Buffers.IByteBuffer" /> and return it</summary>
        /// <param name="ctx">
        ///     the <see cref="UniNetty.Transport.Channels.IChannelHandlerContext" /> which this
        ///     <see cref="UniNetty.Codecs.ByteToMessageDecoder" /> belongs to
        /// </param>
        /// <param name="buffer">the <see cref="UniNetty.Buffers.IByteBuffer" /> from which to read data</param>
        /// <returns>
        ///     the <see cref="UniNetty.Buffers.IByteBuffer" /> which represent the frame or null if no frame could be
        ///     created.
        /// </returns>
