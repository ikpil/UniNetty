...
namespace UniNetty.Buffers
{
    ...
    ///     In general, the <see cref="T:UniNetty.Buffers.IByteBuffer" /> guarantees:
    ///     /// <see cref="P:UniNetty.Buffers.IByteBuffer.ReaderIndex" /> LESS THAN OR EQUAL TO <see cref="P:UniNetty.Buffers.IByteBuffer.WriterIndex" /> LESS THAN OR EQUAL TO
    ///     <see cref="P:UniNetty.Buffers.IByteBuffer.Capacity" />.
    /// </summary>
    public interface IByteBuffer : IReferenceCounted, IComparable<IByteBuffer>, IEquatable<IByteBuffer>
    {
        ...
        Memory<byte> GetPinnableMemoryAddress();
